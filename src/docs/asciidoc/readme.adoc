...
[subs="attributes"]
----
cmd /C "set JAVA_TOOL_OPTIONS="-Dspring.config.location=C:/path/to/config.yml" java -jar C:/path/to/{myapplication}.jar"
----

.Unix
[subs="attributes"]
----
JAVA_TOOL_OPTIONS="-Dspring.config.location=/path/to/config.yml" /path/to/{myapplication}.jar
----
